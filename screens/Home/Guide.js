...
const Guide = ({ userId }) => {
    ...
    if (loading || (guide1 && guide2 && guide3)) {
        return null;
    }
                ...
                <View style={styles.overlay}>
                    <View style={styles.guideBox}>
                        <View style={styles.guideIconText}>
                            ...
                            <Text style={[styles.guideContent, { marginBottom: 20 }]}>
                                The Dashboard Page provides an overview of all your expenses, categorized into various spending types such as Food, Grocery, Shopping, Bills, Medicine, Hardware, and more. It displays the current month's expenses, allowing you to track and manage your spending efficiently.
                            </Text>
                ...
                <View style={styles.overlay}>
                    <View style={styles.guideBox}>
                        <View style={styles.guideIconText}>
                            ...
                            <Text style={[styles.guideContent, { marginBottom: 20 }]}>
                                The Analysis Page provides insights into your spending habits and helps predict future expenses based on past data. This page is designed to assist in financial planning by offering a visual representation of your expenses through pie charts and a prediction model.
                            </Text>
                            <View style={styles.guideUseContainer}>
                ...
                <View style={styles.overlay}>
                    <View style={styles.guideBox}>
                        <View style={styles.guideIconText}>
                            ...
                            <Text style={[styles.guideContent, { marginBottom: 20 }]}>
                                The Report Page provides a detailed breakdown of your expenses based on your selected date and month. This feature allows for efficient tracking, sorting, and printing of all recorded expenses.
                            </Text>
                            <View style={styles.guideUseContainer}>
